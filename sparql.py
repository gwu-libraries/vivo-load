...
def sparql_load(g, htdocs_dir, endpoint, username, password, split_size=None):
...
def sparql_delete(g, endpoint, username, password, split_size=None):
    if split_size:
        ...
        _sparql_delete(g, endpoint, username, password)
