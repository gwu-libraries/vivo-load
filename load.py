...
from loader.utility import remove_extra_args, get_netid_lookup, mediaexpert_intersection, get_skip_name_gwids
...
if __name__ == '__main__':
    ...
    parser.add_argument("--mediaexpert", action="store_true", dest="is_mediaexpert", help="Perform a media expert load.")
